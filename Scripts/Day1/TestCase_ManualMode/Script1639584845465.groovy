...
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/a_Welcome Paul'), 5)

WebUI.click(findTestObject('Page_OrangeHRM/a_Welcome Paul'))

WebUI.click(findTestObject('Page_OrangeHRM/a_Logout'))

WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/input_Password_Submit'), 2)

WebUI.verifyTextPresent('ABCD123', false, FailureHandling.OPTIONAL)
